              ...
              <div>
                ...
                {showSubItems && (
                  <ul className="ml-6 mt-2 space-y-1">
                    <li>
                      <a href="#" className="text-sm text-white hover:text-gray-500 dark:text-gray-400 dark:hover:text-gray-300">
                        View Product
                      </a>
                    </li>
                    <li>
                      <a href="/create-product" className="text-sm text-white hover:text-gray-500 dark:text-gray-400 dark:hover:text-gray-300">
                        Create Product
                      </a>
                    </li>
                    <li>
