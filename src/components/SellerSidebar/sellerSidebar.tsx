          ...
          <ul className="flex flex-col py-4 space-y-1">
              ...
              <div>
                <a
                  ...
                  className={
                    ...
                    (isActive('/viewItems') ? ' bg-white text-emerald-900 border-blue-500' : '')
                  }
                ...
                {showSubItems && (
                  <ul className="ml-6 mt-2 space-y-1">
                    <li>
                      <Link to="/viewItems" className="text-sm text-white hover:text-gray-500 dark:text-gray-400 dark:hover:text-gray-300">
                        View Product
                      </Link>
                    </li>
                    <li>
                      <a href="/sellerPage" className="text-sm text-white hover:text-gray-500 dark:text-gray-400 dark:hover:text-gray-300">
                        Create Product
                      </a>
                    </li>
                    <li>
                      <a href="/update-product" className="text-sm  text-white hover:text-gray-500 dark:text-gray-400 dark:hover:text-gray-300">
                        Update Product
                      </a>
                    </li>
                  </ul>
            ...
            <li>
              ...
              >
                ...
                <span className="hidden md:block px-2 py-0.5 ml-auto text-xs font-medium tracking-wide text-red-500 bg-red-50 rounded-full">0</span>
              </a>
            </li>
            <li onClick={() => navigate('/')}>
              <a
