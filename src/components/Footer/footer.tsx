...
const Footer = () => {
  ...
  return (
    <>
      <hr className="border-t border-[#003D29] mb-12 mt-16 mx-8" />
      <div className="flex mx-16 mb-10 custom-md:text-sm md:text-base">
        <div className="md:w-1/3 custom-md:w-[40%]">
          <img src={Logo} alt="logo" className="h-9 w-36 md: mb-6 custom-md:mb-4" />
          ...
          <div className="grid grid-cols-3 gap-2 mt-10 lg:w-[65%] custom-md:w-[90%]">
            <div className="px-4 py-2  rounded-md border-[1px] w-fit h-fit">
              <img src={payment62} alt="Payment method" className="h-5 w-10 " />
            </div>
            <div className="px-4 py-2  rounded-md border-[1px] w-fit h-fit">
              <img src={payment5} alt="Payment method" className="h-5 w-10 " />
            </div>
            <div className="px-4 py-2  rounded-md border-[1px] w-fit h-fit">
              <img src={payment3} alt="Payment method" className="h-5 w-10 " />
            </div>
            <div className="px-4 py-2  rounded-md border-[1px] w-fit h-fit">
              <img src={payment4} alt="Payment method" className="h-5 w-10 " />
            </div>
            <div className="px-4 py-2  rounded-md border-[1px] w-fit h-fit">
              <img src={payment2} alt="Payment method" className="h-5 w-10 " />
            </div>
            <div className="px-4 py-2  rounded-md border-[1px] w-fit h-fit">
              <img src={payment1} alt="Payment method" className="h-5 w-10 " />
            </div>
          </div>
        </div>
      ...
      <hr className="border-t border-[#003D29] mb-8 mt-16 mx-8" />
